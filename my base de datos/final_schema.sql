...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_com_comments_insert
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_com_comments_delete
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_com_likes_insert
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_com_likes_delete
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_comments_delete
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_likes_insert
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` TRIGGER after_likes_delete
